...
public class DynamoDBLocalFixture
{
	 ...
	 * <p>
	 * $ mvn exec:java
	 * -Dexec.mainClass="com.amazonaws.services.dynamodbv2.DynamoDBLocalFixture" \
	 * -Dexec.classpathScope="test" \ -Dsqlite4java.library.path=target/dependencies
	 * <p>
	 * It's recommended to run "aws configure" one time before you run
