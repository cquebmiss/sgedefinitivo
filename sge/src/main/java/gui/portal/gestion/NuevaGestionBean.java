	...
	public void actionGuardarSolicitud()
	{
		...
		try (Connection conexion = ((DataBase) FacesUtils.getManagedBean("database")).getConnectionGestiones();)
		{
			...
			try
			{
				...
				// caso contrario se registra y se utiliza el nuevo Id
				...
				if (nuevaGestion)
				{
					...
					if (this.gestion.getPaciente().getAtendidoEn() != null)
					{
						prep.setInt(11, this.gestion.getPaciente().getAtendidoEn().getIdUnidadSalud());
					} else
					{
					...
					if (this.gestion.getPaciente().getReferenciadoA() != null)
					{
						prep.setInt(12, this.gestion.getPaciente().getReferenciadoA().getIdUnidadSalud());
				...
				} else
				{
					...
					if (this.gestion.getPaciente().getAtendidoEn() != null)
					{
						prep.setInt(8, this.gestion.getPaciente().getAtendidoEn().getIdUnidadSalud());
					} else
					{
					...
					if (this.gestion.getPaciente().getReferenciadoA() != null)
					{
						prep.setInt(9, this.gestion.getPaciente().getReferenciadoA().getIdUnidadSalud());
				...
				// Se actualiza en la base de datos el id de la tarea de wunderlist y se añade a
				// su registro
				// Se inserta al paciente en la bd
				prep = conexion.prepareStatement(
